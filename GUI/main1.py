...
# Form implementation generated from reading ui file 'qualai_sig.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        #self.lr.sigRegionChanged(self.change_data)
        self.c1_cnt = 0
        self.c2_cnt = 0
        self.c3_cnt = 0
        self.c4_cnt = 0
    ...
    def class_1_img(self):
        ...
        if self.c1_cnt == 0:
            ...
            if ok:
                ...
                self.txt_itm = pg.TextItem(self.class1_txt, color='b', anchor=(0,0))
                self.signalWidget.addItem(self.txt_itm)
                self.c1_cnt = self.c1_cnt + 1
                self.cur_txt = self.class1_txt
                
        elif self.c1_cnt > 0:
            self.lr = pg.LinearRegionItem([0, len(self.signal_df.index.values)])  # This is a mouse-draggable window on the plot
            self.lr.setBounds([0, len(self.signal_df.index.values)])
            self.signalWidget.addItem(self.lr)
            txt_itm = pg.TextItem(self.class1_txt, color='b', anchor=(0,0))
            self.signalWidget.addItem(txt_itm)
    ...
    def class_2_img(self):
        ...
        if self.c2_cnt == 0:
            ...
            if ok:
                ...
                self.lr.setBounds([0, len(self.signal_df.index.values)])
                self.signalWidget.addItem(self.lr)
                txt_itm = pg.TextItem(self.class2_txt, color='b', anchor=(0,0))
                self.signalWidget.addItem(txt_itm)
    ...
    def class_3_img(self):
        ...
        if self.c3_cnt == 0:
            ...
            if ok:
                ...
                self.lr.setBounds([0, len(self.signal_df.index.values)])
                self.signalWidget.addItem(self.lr)
                txt_itm = pg.TextItem(self.class3_txt, color='b', anchor=(0,0))
                self.signalWidget.addItem(txt_itm)
    ...
    def class_5_img(self):
        ...
        if self.c5_cnt == 0:
            ...
            if ok:
                ...
                self.lr.setBounds([0, len(self.signal_df.index.values)])
                self.signalWidget.addItem(self.lr)
                txt_itm = pg.TextItem(self.class5_txt, color='b', anchor=(0,0))
                self.signalWidget.addItem(txt_itm)
    ...
    def class_6_img(self):
        ...
        if self.c6_cnt == 0:
            ...
            if ok:
                ...
                self.lr.setBounds([0, len(self.signal_df.index.values)])
                self.signalWidget.addItem(self.lr)
                txt_itm = pg.TextItem(self.class6_txt, color='b', anchor=(0,0))
                self.signalWidget.addItem(txt_itm)
    ...
    def class_7_img(self):
        ...
        if self.c7_cnt == 0:
            ...
            if ok:
                ...
                self.lr.setBounds([0, len(self.signal_df.index.values)])
                self.signalWidget.addItem(self.lr)
                txt_itm = pg.TextItem(self.class7_txt, color='b', anchor=(0,0))
                self.signalWidget.addItem(txt_itm)
    ...
    def class_8_img(self):
        ...
        if self.c8_cnt == 0:
            ...
            if ok:
                ...
                self.lr.setBounds([0, len(self.signal_df.index.values)])
                self.signalWidget.addItem(self.lr)
                txt_itm = pg.TextItem(self.class8_txt, color='b', anchor=(0,0))
                self.signalWidget.addItem(txt_itm)
    ...
    def class_9_img(self):
        ...
        if self.c9_cnt == 0:
            ...
            if ok:
                ...
                self.lr.setBounds([0, len(self.signal_df.index.values)])
                self.signalWidget.addItem(self.lr)
                txt_itm = pg.TextItem(self.class9_txt, color='b', anchor=(0,0))
                self.signalWidget.addItem(txt_itm)
