...
class Window(QMainWindow):
    ...
    def openFile(self):
        ...
        tim = time.strftime("%Y-%m-%d %H:%M:%S", t_obj)
        print(tim)
        self.first_dt = tim
        self.errorLabel.setText(fileName + " File Creation Date: " + tim)
    ...
    def next(self):
        xd = time.strptime(self.first_dt,"%Y-%m-%d %H:%M:%S")
        xd2 = time.strptime(self.startTime.text(),"%M:%S")
        xd3 = time.strptime(self.endTime.text(),"%M:%S")
        startconvert = (timedelta(hours = xd.tm_hour, minutes=xd2.tm_min, seconds=xd2.tm_sec) + timedelta(minutes=xd.tm_min, seconds=xd.tm_sec))
        endconvert = (timedelta(hours = xd.tm_hour, minutes=xd3.tm_min, seconds=xd3.tm_sec) + timedelta(minutes=xd.tm_min, seconds=xd.tm_sec))
        print(startconvert)
        print(endconvert)
        self.tableWidget.setItem(self.rowNo, self.colNo, QTableWidgetItem(str(startconvert)))
        self.colNo += 1
        self.tableWidget.setItem(self.rowNo, self.colNo, QTableWidgetItem(str(endconvert)))
        self.colNo += 1
        self.tableWidget.setItem(self.rowNo, self.colNo, QTableWidgetItem(str(self.iLabel.text())))
        self.colNo += 1
        #self.tableWidget.setItem(self.rowNo, self.colNo, QTableWidgetItem(self.iLabel.text().split(' ', 1)[1]))
        #self.colNo = 0
        #self.rowNo += 1
    ...
    def insertBaseRow(self):
        ...
        self.tableWidget.setItem(0, 2, QTableWidgetItem("Note"))
